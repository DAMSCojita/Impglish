    ...
    public partial class FormVocabulary : Form
    {
        ...
        public FormVocabulary()
        {
            ...
            questions = new List<Question>
            {
                new Question
                {
                    QuestionText = "¿Cómo se traduce 'Light bulb' al español?",
                    Answers = new string[] { "Bombilla", "Bola", "Linterna" },
                    CorrectAnswer = "Bombilla"
                },
                new Question
                {
                    QuestionText = "¿Cómo se traduce 'Camino' en inglés?",
                    Answers = new string[] { "Way", "Walk", "Path" },
                    CorrectAnswer = "Path"
                },
                new Question
                {
                    QuestionText = "¿Cómo se traduce 'Gloves' al español?",
                    Answers = new string[] { "Gol", "Guantes", "Trébol" },
                    CorrectAnswer = "Guantes"
                },
                new Question
                {
                    QuestionText = "¿Cómo se traduce 'Pantalla' en inglés?",
                    Answers = new string[] { "Screen", "Screech", "Cream" },
                    CorrectAnswer = "Screen"
                },
                new Question
                {
                    QuestionText = "¿Cómo se traduce 'Widow' al español?",
                    Answers = new string[] { "Viento", "Ventana", "Viuda" },
                    CorrectAnswer = "Viuda"
                }
